...
async function request(path, { method = 'GET', body, token, headers = {} } = {}) {
  ...
  try {
    ...
    const message = `Network error: failed to reach API at ${STATION_BASE_URL}. If you are running the API locally, the hosted preview cannot access localhost. Use a public URL or run the frontend locally.`
